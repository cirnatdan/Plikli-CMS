...
function plikli_createtables($conn) {
	...
	**********************************/
	...
	$sql = "CREATE TABLE `" . table_links . "` (
	  ...
	  `link_published_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
	  `link_category` int(11) NOT NULL default '0',
	  `link_lang` int(11) NOT NULL default '1',
	  `link_url` varchar(11) collate utf8_general_ci NOT NULL default '',
	...
	$sql = "CREATE TABLE `" . table_users . "` (
	  ...
	  `last_reset_request` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
